...
![A single-player game: the board, the roll and the scores](../assets/screenshots/single-player.png)
...
![The results: You win, the scores, and buttons to play again or open the shop](../assets/screenshots/results.png)
...
![Practice settings: difficulty, level, times tables and number of questions](../assets/screenshots/practice-menu.png)

![A practice question with the keypad](../assets/screenshots/practice.png)
...
![The shop: unlocks grouped by kind, with the wallet at the bottom](../assets/screenshots/shop.png)

The **Wardrobe** has looks: colours, dice, board themes, keypads and titles.

![The Wardrobe](../assets/screenshots/wardrobe.png)

**Stats** shows every game and the Times Table: which facts are mastered, still being learned, or need practice.

![Stats: recent games and the Times Table](../assets/screenshots/stats.png)
...
![A signed-in student's menu with the Homework button and a tournament banner](../assets/screenshots/student-menu.png)

![A student's homework list with Play buttons](../assets/screenshots/student-homework.png)
