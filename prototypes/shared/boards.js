...
// Loaded as a plain script (window.ProtoBoards) and via require() in tests.
//
...
(function (root) {
  ...
  const api = {
    ...
    gridCount,
    barRoom,
    placements: (b, piece) => KINDS[b.kind].placements(b, piece),
    fits: (b, piece) => KINDS[b.kind].fits(b, piece),
    place: (b, piece, p, owner, correct) => KINDS[b.kind].place(b, piece, p, owner, correct),
    cpuChoose: (b, piece, rng) => KINDS[b.kind].cpuChoose(b, piece, rng),
    progress: (b) => KINDS[b.kind].progress(b),
  };
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  else root.ProtoBoards = api;
