...
// Loaded as a plain script (window.ProtoVariants) and via require() in tests.
//
...
(function (root) {
  ...
  const Fr = typeof module !== 'undefined' && module.exports ? require('./fraction.js') : root.Fraction;
  const Boards = typeof module !== 'undefined' && module.exports ? require('./boards.js') : root.ProtoBoards;
  const { F } = Fr;
  const s = Fr.str;
  ...
  const api = { VARIANTS, BAR_UNITS, WHOLE, byId: (id) => VARIANTS.find((v) => v.id === id) };
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  else root.ProtoVariants = api;
