...
// Loaded as a plain script (window.Fraction) and via require() in tests.
(function (root) {
  'use strict';
  ...
  const api = { gcd, lcm, F, add, sub, mul, div, cmp, eq, ZERO, ONE, toUnits, str, mixed, parseAnswer };
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
  else root.Fraction = api;
